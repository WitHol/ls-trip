...
install:
	@echo "creating an executable at /usr/local/bin/ls-trip..."
	@cp target/debug/ls-trip /usr/local/bin/ls-trip
...
update:
	...
	@echo "putting the new executable at /usr/local/bin/ls-trip"
	@cp -f target/debug/ls-trip /usr/local/bin/ls-trip